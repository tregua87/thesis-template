...
\chapter{A Practical and Scalable TEE-enforced Software Protection}
...
program~\citep{collberg2002watermarking}.
...
execution~\citep{diversig,abera2016c}.
...
In our scenario, an attacker can compromise the victim logic (\ie the byte code) 
...
\paragraph{Overcoming Denial of Service Issues.}
...
with a heartbeat~\citep{ghosh2010secure}. %, which is depicted in 
...
\paragraph{Function Calls and Recursions.}
...
%\end{description}
\paragraph{Exceptions within Critical Section.}
%Modern program languages, like C++, allow a user to raise exceptions in order 
%to handle unpredictable program behaviors.
%These mechanism might bring our anti-tampering system to an unstable 
...
\paragraph{Multi-threading programs.}
...
\paragraph{Ensuring a Secure Booting Phase.}
...
\paragraph{Protection against disarm.}
