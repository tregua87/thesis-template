...
%code~\cite{amsterdamsgxmalwer,schwarz2017malware,sgxrop}. Albeit
...
\begin{itemize}
	...
	container~\citep{baumann2015shielding,tsai2017graphene,seo2017sgx,199364}.
...
\begin{itemize}
	...
	are growing in 
	complexity~\citep{sqlite-sgx,sgxtor,signal,tsai2017graphene,stealthdb}.
\end{itemize}
...
\begin{table}
	...
	\begin{tabular}{lcc}
		...
		sfaas & \checkmark & 3 \\
		phoenix & \multicolumn{2}{l}{Graphene~\cite{tsai2017graphene}} \\
		posup & \checkmark & 4 \\
...
Intel SGX SDK, while others were developed with 
Graphene~\citep{tsai2017graphene}, Open 
...
highlight these issues and propose possible mitigation.
...
setting~\citep{rozas2013intel}, an unexpected configuration may attract 
analysts attention (\ie the host can read the enclave page permissions).
...
\begin{figure}[t]
	...
	\caption[SnakeGX installation layout.]{Trusted thread stack after SnakeGX 
...
exfiltrated~\citep{shacham2007geometry}.
