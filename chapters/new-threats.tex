...
in the system memory (Section~\ref{ssec:code-reuse-sgx}\todo{ in background}).
...
\begin{itemize}
	...
	(see Section~\ref{ssec:code-reuse-sgx}\todo{background}).
...
functions described in Section~\ref{sec:background}\todo{background}.
