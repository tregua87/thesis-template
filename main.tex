...
%In fact, they suffer from many limitations that range from scalability issues 
%to new security threats.
%In fact, they suffer from many limitations: 
the \emph{trusted regions}' size is capped at few megabytes, thus having 
scalability issues; 
a \emph{trusted region} may be misused to hide a malware, thus leading to new 
security threats; 
