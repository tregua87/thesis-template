...
\todo{to change with my papers}
\section*{Conference Proceedings}
\begin{itemize}
	\item Castellanos, J. H., Maghenem, M., C\'ardenas, A., Sanfelice, R. G., 
	\& Zhou, J. (2021). 
	Towards Provable Physical Safety Against False Actuation Attacks in CPS.
	(Under review at UsenixSec'22).\footnote{These papers contribute to the 
	thesis content.}
	\item Esquivel-Vargas, H., Caselli, M., Castellanos, J. H., \& Peter, A. 
	(2021).
	Towards Automated Weakness Identification in Cyber-Physical Systems.
	(Under review at S\&P'22).
	\item Castellanos, J. H., Ochoa, M., C\'ardenas, A., Arden, O., \& Zhou, J. 
	(2021). 
	AttkFinder: Discovering Attack Vectors in PLC Programs using Information 
	Flow Analysis. 
	(To appear at RAID'21).\footnotemark[\value{footnote}]
	\item Castellanos, J. H., \& Zhou, J. (2019, June). 
	...
	ACNS19.\footnotemark[\value{footnote}]
	\item Castellanos, J. H., Ochoa, M., \& Zhou, J. (2018, December). 
	Finding Dependencies between Cyber-Physical Domains for Security Testing of 
	Industrial Control Systems. 
	In the Annual Computer Security Applications Conference -- 
	ACSAC18.\footnotemark[\value{footnote}]
	\item Castellanos, J. H., Antonioli, D., Tippenhauer, N. O., \& Ochoa, M. 
	(2017, July). 
	Legacy-Compliant Data Authentication for Industrial Control System Traffic. 
	In Applied Cryptography and Network Security -- ACNS17.

\end{itemize}

\section*{Workshop Proceedings}
\begin{itemize}
	\item Hau, Z., Castellanos, J. H., \& Zhou, J. (2020, October). 
	Evaluating Cascading Impact of Attacks on Resilience of Industrial Control 
	Systems: A Design-Centric Modeling Approach. 
	In the Cyber-Physical System Security Workshop - CPSS20.
	\item Harilal, A., Toffalini, F., Castellanos, J., Guarnizo, J., Homoliak, 
	I., \& Ochoa, M. (2017, October). 
	TWOS: A Dataset of Malicious Insider Threat Behavior Based on a Gamified 
	Competition. 
	In the International Workshop on Managing Insider Security Threats - MIST17.
	\item Chekole, E. G., Castellanos, J. H., Ochoa, M., \& Yau, D. K. (2017). 
	Enforcing memory safety in cyber-physical systems. 
	In Computer Security - ESORICS International Workshops, CyberICPS.
