...
Are you sure the last Virtual Machine bought from your Could Provider is 
working properly?
...
Thus arising the need of advanced protections for the companies' products and 
data.
...
flexible designs fitting the current market products 
...
performing incident response, propose new techniques, and show research 
directions to fulfill the current gaps (Chapter~\ref{chp:forensic}).
...
specifications, thus stretching the runtime protection over \emph{memory 
...
his group.
Finally, Lorenzo, for his extraordinary teachings and inspirational vision.
